    ...
    private fun drawToAllSurfaces(matrix: FloatArray, contentW: Int, contentH: Int): Boolean {
        ...
        while (it.hasNext()) {
            ...
            try {
                ...
                val videoCompensation = if (isVideo) (90 - (videoPlayer?.videoRotation ?: 0)) 
                                        else if (isStream) (90 - (streamPlayer?.videoRotation ?: 0))
                                        else 0
                ...
                // Emulate missing hardware EXIF rotation (-90 deg CW) for downloaded videos AND upright streams
